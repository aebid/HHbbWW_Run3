...
class HeavyMassEstimator(object):
    ...
    def runHME(self):
        ...
        while (it < self.iterations ):
            ...
            if self.debug:
                print("it ",it," self.eta_gen[0] ",self.eta_gen[0]," wmass_gen ",self.wmass_gen[0], " self.phi_gen[0] ", self.phi_gen[0], " hmass_gen ", self.hmass_gen[0])
            #smearing met
            ...
            while isolution < len(solutions):
                ...
                if solutions[isolution]:
                    self.nsolutions[0] += 1
                isolution += 1  ## end of first while isolution < len(solutions)
            isolution = 0
            ...
            while isolution < len(solutions):
                ...
                if self.debug:
                    print("nu1 p4 ", self.nu_onshellW_p4.Pt(), self.nu_onshellW_p4.Eta(), self.nu_onshellW_p4.Phi(), self.nu_onshellW_p4.Energy())
                if self.debug:
                    print("nu2 p4 ", self.offshellW_p4.Pt(), self.offshellW_p4.Eta(), self.offshellW_p4.Phi(), self.offshellW_p4.Energy())
                self.htoWW_p4 = self.onshellW_p4 + self.offshellW_p4
                htoWW_vals[isolution] = self.htoWW_p4.M()
            ...
            if self.debug: print("it/sols", it, htoWW_vals)
