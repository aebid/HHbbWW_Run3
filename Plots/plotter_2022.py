...
"""
#Single Channel DNN Input Plots
cut = "(Single_Signal)"
...
binlow = 0.0
binhigh = 1.0
make_plot('Singlelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "single_DNNinputs/")
...
cut = "((Double_Signal) && (nBjets_pass) && (Zveto)) && (Double_HbbFat) && (double_is_ee)"
var = 'ak8_jet0_pt'
varname = 'fatjet 0 pT'
varunit = 'GeV'
nBins = 100
binlow = 200.0
binhigh = 800.0
make_plot('Doublelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "jan30_run3/boosted_ee/")


cut = "((Double_Signal) && (nBjets_pass) && (Zveto)) && (Double_HbbFat) && (double_is_mm)"
make_plot('Doublelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "jan30_run3/boosted_mm/")

cut = "((Double_Signal) && (nBjets_pass) && (Zveto)) && (Double_HbbFat) && (double_is_em || double_is_me)"
make_plot('Doublelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "jan30_run3/boosted_em/")


"""
cut = "((Double_Signal) && (nBjets_pass) && (Zveto))"
var = 'npvs'
varname = 'nPrimaryVertex'
varunit = ''
nBins = 50
binlow = 0.0
binhigh = 50.0
make_plot('Doublelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "dec5_prevpf/double_DNNinputs/")


cut = "((Double_Signal) && (nBjets_pass))"
var = 'Zveto'
varname = 'Zveto Preselected Leps'
varunit = ''
nBins = 4
binlow = 0.0
binhigh = 4.0
make_plot('Doublelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "nov28/double_DNNinputs/")

cut = "((Double_Signal) && (nBjets_pass))"
var = 'Zveto_fakeable'
varname = 'Zveto Fakeable Leps'
varunit = ''
nBins = 4
binlow = 0.0
binhigh = 4.0
...
"""
cut = "((Double_Signal) && (nBjets_pass) && (Zveto))"
var = 'double_event_weight'
varname = 'event weight SF'
varunit = 'weight'
nBins = 40
binlow = -0.5
binhigh = 5.0
...
cut = "((Double_Signal) && (nBjets_pass) && (Zveto))"
var = 'lep0_lepton_tight_TTH_SF'
varname = 'lep0 tight TTH SF'
varunit = 'weight'
nBins = 20
binlow = 0.0
binhigh = 2.0
...
cut = "((Double_Signal) && (nBjets_pass) && (Zveto))"
var = 'lep0_lepton_relaxed_TTH_SF'
varname = 'lep0 relaxed TTH SF'
varunit = 'weight'
nBins = 20
binlow = 0.0
binhigh = 2.0
...
cut = "((Double_Signal) && (nBjets_pass) && (Zveto))"
var = 'lep1_lepton_tight_TTH_SF'
varname = 'lep1 tight TTH SF'
varunit = 'weight'
nBins = 20
binlow = 0.0
binhigh = 2.0
...
cut = "((Double_Signal) && (nBjets_pass) && (Zveto))"
var = 'lep1_lepton_relaxed_TTH_SF'
varname = 'lep1 relaxed TTH SF'
varunit = 'weight'
nBins = 20
binlow = 0.0
binhigh = 2.0
...
cut = "((Double_Signal) && (nBjets_pass) && (Zveto))"
var = 'n_presel_muons'
varname = 'number of preselected muons'
varunit = ''
nBins = 10
binlow = 0.0
binhigh = 10.0
make_plot('Doublelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "nov20/double_DNNinputs_SF/")

cut = "((Double_Signal) && (nBjets_pass) && (Zveto))"
var = 'n_presel_electrons'
varname = 'number of preselected electrons'
varunit = ''
nBins = 10
binlow = 0.0
binhigh = 10.0
