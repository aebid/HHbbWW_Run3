...
"""
Zmass = 91.1876
b0_Zin = "(n_medium_btag_ak4_jets == 0) && (abs(ll_mass - {Zmass}) < 10)".format(Zmass = Zmass)
b1_Zin = "(n_medium_btag_ak4_jets == 1) && (abs(ll_mass - {Zmass}) < 10)".format(Zmass = Zmass)
b2_Zin = "(n_medium_btag_ak4_jets == 2) && (abs(ll_mass - {Zmass}) < 10)".format(Zmass = Zmass)

b0_Zout = "(n_medium_btag_ak4_jets == 0) && (abs(ll_mass - {Zmass}) > 10)".format(Zmass = Zmass)
b1_Zout = "(n_medium_btag_ak4_jets == 1) && (abs(ll_mass - {Zmass}) > 10)".format(Zmass = Zmass)
b2_Zout = "(n_medium_btag_ak4_jets == 2) && (abs(ll_mass - {Zmass}) > 10)".format(Zmass = Zmass)
...
binlow = 0.0
binhigh = 200.0
cut = "(Double_Fake || Double_Signal) && "+b0_Zin
make_plot('Doublelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "2016_DY_Plots_b0_Zin/")
cut = "(Double_Fake || Double_Signal) && "+b1_Zin
make_plot('Doublelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "2016_DY_Plots_b1_Zin/")
cut = "(Double_Fake || Double_Signal) && "+b2_Zin
make_plot('Doublelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "2016_DY_Plots_b2_Zin/")
cut = "(Double_Fake || Double_Signal) && "+b0_Zout
make_plot('Doublelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "2016_DY_Plots_b0_Zout/")
cut = "(Double_Fake || Double_Signal) && "+b1_Zout
make_plot('Doublelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "2016_DY_Plots_b1_Zout/")
cut = "(Double_Fake || Double_Signal) && "+b2_Zout
make_plot('Doublelepton',var, nBins, binlow, binhigh, varname, varunit, True, False, True, cut, "2016_DY_Plots_b2_Zout/")
