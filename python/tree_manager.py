...
def update_outfile(EventProcess, outfile):
    ...
    if len(events_single) != 0:
        ...
        event_dict_single = {
            ...
            'n_muons': np.array(ak.num(muons_single, axis=1), dtype=np.int32),
            ...
            'n_electrons': np.array(ak.num(electrons_single, axis=1), dtype=np.int32),
            ...
            'n_ak4_jets': np.array(ak.num(ak4_jets_single, axis=1), dtype=np.int32),
            ...
            'n_ak8_jets': np.array(ak.num(ak8_jets_single, axis=1), dtype=np.int32),
            ...
            'AtLeastOneFakeableLep': np.array(events_single.AtLeastOneFakeableLepSingle, dtype=np.int32),
            'PassesMETFilters': np.array(events_single.PassesMETFiltersSingle, dtype=np.int32),
            'LeadLeptonConePtCut': np.array(events_single.LeadLeptonConePtCutSingle, dtype=np.int32),
            'InvarMassCut': np.array(events_single.InvarMassCutSingle, dtype=np.int32),
            'ZMassCut': np.array(events_single.ZMassCutSingle, dtype=np.int32),
            'PassesHLTCuts': np.array(events_single.PassesHLTCutsSingle, dtype=np.int32),
            'AtMostOneTightLep': np.array(events_single.AtMostOneTightLepSingle, dtype=np.int32),
            'TauVeto': np.array(events_single.TauVetoSingle, dtype=np.int32),
            'AtLeastOneBJet': np.array(events_single.AtLeastOneBJetSingle, dtype=np.int32),
            'EnoughNonBJets': np.array(events_single.EnoughNonBJetsSingle, dtype=np.int32),
    ...
    if len(events_double) != 0:
        ...
        event_dict_double = {
            ...
            'n_muons': np.array(ak.num(muons_double, axis=1), dtype=np.int32),
            ...
            'n_electrons': np.array(ak.num(electrons_double, axis=1), dtype=np.int32),
            ...
            'n_ak4_jets': np.array(ak.num(ak4_jets_double, axis=1), dtype=np.int32),
            ...
            'n_ak8_jets': np.array(ak.num(ak8_jets_double, axis=1), dtype=np.int32),
            ...
            'double_is_me': np.array(ak.fill_none(events_double.is_me, False), dtype=np.int32),

            'AtLeastTwoFakeableLeps': np.array(events_double.AtLeastTwoFakeableLepsDouble, dtype=np.int32),
            'PassesMETFilters': np.array(events_double.PassesMETFiltersDouble, dtype=np.int32),
            'LeadSubleadChargeCut': np.array(events_double.LeadSubleadChargeCutDouble, dtype=np.int32),
            'LeadSubleadLeptonConePtCut': np.array(events_double.LeadSubleadLeptonConePtCutDouble, dtype=np.int32),
            'ZMassCut': np.array(events_double.ZMassCutDouble, dtype=np.int32),
            'InvarMassCut': np.array(events_double.InvarMassCutDouble, dtype=np.int32),
            'PassesHLTCuts': np.array(events_double.PassesHLTCutsDouble, dtype=np.int32),
            'AtMostTwoTightLeps': np.array(events_double.AtMostTwoTightLepsDouble, dtype=np.int32),
            ...
            'nBjets_pass': np.array(ak.fill_none(events_double.nBjets_passDouble, False), dtype=np.int32),
