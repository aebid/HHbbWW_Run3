...
python3 -i run_bbWW_processing.py -i GluGlutoRadiontoHHto2B2Vto2B2L2Nu_M-450_testfile.root -o GluGlutoRadiontoHHto2B2Vto2B2L2Nu_M450_Run3Sync.root -ry 2022 -re D -MC 1 -t 0 -d 0 -XS 1.0 -SF 0 -HLTCut 0
